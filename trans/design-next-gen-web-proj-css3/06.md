...
![Discovering perspective](graphics/3264OT_06_1.jpg)

增加`perspective`属性的值时，结果将看起来更平坦，另一方面，如果此属性减小，红色框将看起来延伸到地平线。下面是一个带有`perspective: 250px`的示例：

![Discovering perspective](graphics/3264OT_06_2.jpg)
...
![Creating a cube](graphics/3264OT_06_3.jpg)
...
![Creating a cube](graphics/3264OT_06_4.jpg)
...
![The perspective-origin property](graphics/3264OT_06_5.jpg)
...
![Implementing parallax scrolling in WebKit](graphics/3264OT_06_6.jpg)
...
![Implementing parallax scrolling in Gecko](graphics/3264OT_06_7.jpg)
...
![Implementing parallax scrolling in Internet Explorer](graphics/3264OT_06_8.jpg)
...
![Adding some randomness to the gallery](graphics/3264OT_06_09.jpg)
...
![Rotating the images](graphics/3264OT_06_10.jpg)
...
![A 3D panorama](graphics/3264OT_06_11.jpg)

# 处理旧浏览器

尽管该项目的核心效果利用了一些旧版本浏览器无法模拟的 CSS 3D 属性，但整个结构仅使用与 CSS 2 兼容的属性和选择器，因此几乎可以从任何浏览器查看：

![Dealing with older browsers](graphics/3264OT_06_12.jpg)
