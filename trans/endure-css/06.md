...
以这种方式将状态变化嵌套在规则中的能力增加了开发人员的工效学。目的是在整个应用风格中，规则只在根级别定义一次。这提供了一个单一的真理来源来定义与该类相关的所有可能的事件。更多信息，请务必阅读[第 8 章](08.html "Chapter 8. The Ten Commandments of Sane Style Sheets")、*理智样式表的十条戒律*。
