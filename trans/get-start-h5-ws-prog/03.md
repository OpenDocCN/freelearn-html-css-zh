...
![Why do I need a WebSocket server?](graphics/6962_03_01.jpg)
...
![The complete source code](graphics/6962_03_02.jpg)

以下屏幕截图显示第二个用户同时使用 Internet Explorer 10 聊天：

![The complete source code](graphics/6962_03_03.jpg)
