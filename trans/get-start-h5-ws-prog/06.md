...
在 HTML5 之前的时代，浏览器插件对于富互联网应用程序来说是一个非常有用的解决方案。仅举几个例子，开发人员过去常常利用 Flash（主要是 Flash）、Silverlight 或 Java 的功能在其网站中提供桌面丰富的功能。几年前，基本的用户体验效果、转换和动画无法使用普通的 HTML、CSS 或 JavaScript 制作。
