...
![Building the Untangle Game with Canvas and the Drawing API](graphics/B04290_04_01.jpg)
...
5.  Open the `index.html` file in a web browser and we will get the following screenshot:
    ...
    ![Time for action – drawing color circles in the Canvas](graphics/B04290_04_02.jpg)
...
![Closing a path](graphics/B04290_04_03.jpg)
...
4.  Open the HTML file in the web browser to see the result:
    ...
    ![Time for action – putting the circle drawing code into a function](graphics/B04290_04_04.jpg)
...
10.  Test the code in the web browser. We should see there are lines connected to each randomly placed circle:
    ...
    ![Time for action – drawing straight lines between each circle](graphics/B04290_04_05.jpg)
...
7.  Open `index.html` in a web browser. There should be five circles with lines connecting them. Try dragging the circles. The dragged circle will follow the mouse cursor and the connected lines will follow too.
    ...
    ![Time for action – dragging the circles in the Canvas](graphics/B04290_04_06.jpg)
...
![Detecting mouse events in circles in the Canvas](graphics/B04290_04_07.jpg)
...
![Clearing the Canvas](graphics/B04290_04_10.jpg)
...
![Determining whether two line segments intersect](graphics/B04290_04_08.jpg)
...
![Determining whether two line segments intersect](graphics/B04290_04_09.jpg)
...
我们刚刚为我们的解开游戏添加了触摸支持。您可以在[找到代码和示例 http://makzan.net/html5-games/untangle-wip-dragging/](http://makzan.net/html5-games/untangle-wip-dragging/) 。
...
现在，您已经了解了画布中的基本绘图功能和绘图 API，现在可以学习画布中的一些高级绘图技术了。在下一章中，我们将继续代码示例，创建一个解谜游戏。您还将学习更多画布绘制技术，例如绘制文本、绘制图像和创建多个绘图层。