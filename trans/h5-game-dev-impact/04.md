...
1.  从我们在[第 1 章](01.html "Chapter 1. Firing Up Your First Impact Game")*准备的原始Impact可下载文件夹中复制一份，启动您的第一个Impact游戏*。或者，你可以再次下载一个新的，并把它放在你的 XAMPP 服务器的`htdocs`目录。为您的文件夹命名；让我们完全原创，称之为`chapter4`。其他名字也可以。
