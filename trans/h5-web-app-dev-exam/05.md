...
我们在应用程序中添加了一个文本工具，允许用户在画布上键入文本，并绘制填充或轮廓。
...
HTML5 的伟大之处之一是你可以编写一个应用程序，它将在许多不同的设备上工作。Canvas Pad 作为一个桌面应用程序非常好用，在这里可以使用鼠标事件。但是它在触摸屏设备上也同样有效。因此，让我们向应用程序添加对触摸事件的支持。
...
![What just happened?](graphics/5947OT_05_01.jpg)
