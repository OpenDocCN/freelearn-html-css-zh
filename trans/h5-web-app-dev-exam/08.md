...
![Time for action – getting XML data](graphics/5947OT_08_02.jpg)
...
![HTML5 Geolocation API](graphics/5947OT_08_01.jpg)
...
![Time for action – getting geolocation data](graphics/5947OT_08_03.jpg)

如果地理定位请求由于某种原因失败，我们会从错误对象获得错误消息，并在页面上显示:

![Time for action – getting geolocation data](graphics/5947OT_08_05.jpg)
...
![Time for action – calling the weather service](graphics/5947OT_08_04.jpg)
