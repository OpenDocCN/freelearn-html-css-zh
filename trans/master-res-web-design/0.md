...
[第三章](3.html "Chapter 3. Mobile-first or Desktop-first?")、*手机优先还是桌面优先？*，澄清为什么以及何时应首先使用移动设备或桌面设备。通过示例，我们将学习如何使用自适应 Web 设计，当然还有 RWD 来改进站点。我们将学习*Respond.js*和条件类，以便在构建 mobile first 时支持传统浏览器。
