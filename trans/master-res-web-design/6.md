...
通过另一个图像优化工具运行图像，可以是一个独立的应用，如 Mac 的 ImageOptim 或Windows 的激进图像优化工具（RIOT），也可以是一个在线服务，如[https://tinypng.com/](https://tinypng.com/) 或[http://www.jpegmini.com/](http://www.jpegmini.com/) 。
