...
![](Images/78f442d6-4ff8-45d9-bad1-4181bb70b9c4.png)
...
![](Images/e81c74fe-a429-4888-844f-5b0231f501e3.png)
...
![](Images/679721ca-ec4c-472c-8dab-93db93e873f8.png)

第二张截图显示了调整后的值，并以相应的方式改变圆元素:

![](Images/61019910-73f6-4104-a8fe-b2d9f22c609b.png)
...
![](Images/e6996342-dc66-40a8-aeca-cacbb33cd7b7.png)
...
![](Images/69ce9e39-72c3-4440-91bb-e24b1e65ee66.png)

2.  下一步是进入您刚刚创建的文件夹并运行`npm install`:

![](Images/4260a2d0-c0bf-4637-8a08-bce5d90db340.png)
...
![](Images/a23bd629-8d25-487a-b286-285ec1c0a6de.png)
...
![](Images/d9e8b949-b4ea-493c-ba95-60fb6ede1ca3.png)
...
![](Images/1be8b908-3865-4ae3-852d-ab260405e18a.png)
...
![](Images/4e746339-5776-421b-9d45-09f97e6b244b.png)
...
![](Images/a6f94d94-1a97-46a0-8436-e2e5318f92d0.png)

持续的结果:

![](Images/1fe0854b-769e-4e42-9028-6600aa34dd1f.png)
...
![](Images/b8d327e3-5bdf-48bf-9436-adf481b64ec3.png)
...
![](Images/3d1c8368-67d7-4232-a3a3-9a3ab354ee50.png)

从项目文件夹的根目录运行`yarn start`将编译所有的 React 代码和 CSS，并在 localhost 上启动一个可用的开发服务器:

![](Images/39ac6a11-a210-4555-bddb-b0f7b913ad87.png)

如果你想知道的话，starter 应用程序如下所示。 我们很快就会把它吹走:

![](Images/22df7d11-f3c3-4a30-b55a-1b1f8f0c707a.png)
