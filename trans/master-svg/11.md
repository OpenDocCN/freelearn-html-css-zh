...
![](Images/9d8d598b-8a7f-42e7-bd50-6bedead62d96.png)

如果您查看`svgo.svg`源代码中优化前后的变化，就会发现明显的差异。

下面的截图显示了 Inkscape 在编写过程中添加的元数据:

![](Images/1869e97d-22ba-48bc-9ce5-0b2fed462670.png)

这张截图显示了优化后的清理文件:

![](Images/d05d9dbb-2867-40d7-be10-88de011cb70c.png)
...
![](Images/1130e1ce-0b61-4d6c-90a2-151487bc445e.png)
...
![](Images/e270fb80-99f5-4bf9-84bb-0f11ed55588a.png)
