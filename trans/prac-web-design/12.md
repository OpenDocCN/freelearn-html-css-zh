...
如果你向下滚动一点，你会注意到 BoostrapCDN。 Bootstrap还提供了一个 C****用分发网络**(**CDN)将托管 Bootstrap 在服务器的最新版本,所以你只能粘贴 URL,而无需主机服务器上的文件。 这很好，因为您的用户不需要再次下载文件，因为它可能已经通过使用 Bootstrap 访问另一个网站下载了文件。****
