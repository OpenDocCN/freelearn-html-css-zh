...
![Exploring some examples](graphics/image_04_001.jpg)

尝试调整浏览器窗口的大小; 如果你变得足够小，你会看到类似这样的东西:

![Exploring some examples](graphics/image_04_002.jpg)

这里还有另一个例子——我们不能忘记这本书的出版商 Packt 的网站:

![Exploring some examples](graphics/image_04_003.jpg)

尝试改变浏览器窗口的大小。 如果我们调整它的大小，它将显示如下:

![Exploring some examples](graphics/image_04_004.jpg)

对于我们的第三个也是最后一个例子，让我们去访问 CSS 技巧，由 Chris Coyier 创建的网站，在[http://www.css-tricks.com](http://www.css-tricks.com):

![Exploring some examples](graphics/image_04_005.jpg)

如果我们将其调整为更小的宽度，这是我们将得到的结果:

![Exploring some examples](graphics/image_04_006.jpg)
...
![Putting our theory into practice](graphics/image_04_007.jpg)
...
![Putting our theory into practice](graphics/image_04_008.jpg)
...
11.  Save the file, then preview the results in a browser. Ideally, this should be Google Chrome or an alternative such as Firefox:
    ...
    ![Making it real](graphics/image_04_009.jpg)
...
![Making it real](graphics/image_04_010.jpg)

我们可以使用 Chrome 的设备模式来切换方向为横向:

![Making it real](graphics/image_04_011.jpg)

我们可以看到网站重新调整了自己:

![Making it real](graphics/image_04_012.jpg)
...
![Exploring what happened](graphics/image_04_013.jpg)
...
5.  Go ahead and preview the results of our file. If all is well, we will see something akin to this screenshot:
    ...
    ![Detecting high-resolution image support](graphics/image_04_014.jpg)
...
6.  To confirm what size is shown, first activate the Developer toolbar by pressing ***Ctrl* + *Shift* + *I***. Then enable device mode by pressing ***Ctrl* + *Shift* + *M***. We will see a toolbar similar to this appear:
    ...
    ![Detecting high-resolution image support](graphics/image_04_015.jpg)

这里有两点需要注意:一个是左边的设置(**Responsive**)，另一个是 DPR 或设备像素比。 要触发显示更高分辨率的图像，请尝试更改左边的设置为**iPhone 6 Plus**:

![Detecting high-resolution image support](graphics/image_04_016.jpg)

注意 DPR 设置是如何跳转到`3.0`的，我们的图像发生了改变:

![Detecting high-resolution image support](graphics/image_04_017.jpg)
...
![Exploring how it works](graphics/image_04_018.jpg)
