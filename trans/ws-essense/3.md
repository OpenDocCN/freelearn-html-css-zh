...
我们可以从中选择不同的JavaScript 库。 为创建应用提供足够功能的库是**reveal.js**。 它是一个制作精良的 API，完全基于 HTML5。 还有一个制作精良的应用用于制作在线演示，它也是基于我们将要使用的相同的 JavaScript 库。 相关网站为[www.slides.com](http://www.slides.com)。 去访问这个网站吧; 这会让你对我们的演讲有个大概的了解。 我们将使用这个 API 并使其协作，以便其他用户也可以改变幻灯片，每个人都可以看到反射。
